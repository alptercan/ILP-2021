...
public class AppTest {
    ...
    public void testMenusOne() {
        ...
        int totalCost = menus.getDeliveryCost(
                "Ham and mozzarella Italian roll", "Ham and mozzarella Italian roll", "Ham and mozzarella Italian roll", "Ham and mozzarella Italian roll"
        );
    ...
    public void testMenusTwo() {
        ...
        Menus menus = new Menus("localhost", "9898");
        int totalCost = menus.getDeliveryCost(
                "Ham and mozzarella Italian roll", "Ham and mozzarella Italian roll", "Ham and mozzarella Italian roll",
    ...
    public void testMenusThree() {
        ...
        Menus menus = new Menus("localhost", "9898");
        int totalCost = menus.getDeliveryCost(
                "Ham and mozzarella Italian roll", "Ham and mozzarella Italian roll",
                "Salami and Swiss Italian roll",
                "Flaming tiger latte"
        );
        // Don't forget the standard delivery charge of 50p
